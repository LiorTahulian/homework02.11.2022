class User {
    ...
    getDetailsOfTheUser() {
        ...
        return ('The user ' + this.#firstName + ' ' + this.#lastName + " from " + this.#hometown + " borrowed the books: " + allbooks);
    }
}
...
class WeeklyReport {
    ...
    showTheBorrowedBooks() {
        this.allTheUsers.forEach(element => {
            console.log(element.getDetailsOfTheUser());
        });
    }
}
...
// console.log(report1.allTheUsers);
report1.showTheBorrowedBooks();